  ...
  return (
    <div className="px-5">
      ...
      <div className="mt-20 px-40">
        ...
        <div className="text-[#4D4E4F] text-[20px] mt-10">
          We empower farmers by prioritizing distress sales of their produce and
          enhance income capacity by 20-30% through an integrated globally
        ...
        <div className="text-[#4D4E4F] text-[20px] mt-7 font-[500]">
          <ul className="list-disc list-inside pl-0">
            ...
            <li>
              ...
              stored agro commodities in our warehouse network, we ensure their
              working capital remains unobstructed and safe.
            </li>
            <li>
